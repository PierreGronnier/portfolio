...
const timeline = [
  ...
  },
  {
    ...
    detail:
      "Built the front-end of a invoice-generation website for this association from the ground up. First real taste of shipping something people actually use.",
    icon: Briefcase,
  },
  {
    year: "2022-2023",
